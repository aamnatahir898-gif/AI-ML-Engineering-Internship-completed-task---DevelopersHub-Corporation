...
- **Pre-processing:** - Handled missing values by dropping columns with low data density (`ca`, `thal`, `slope`).
...
- **Performance Evaluation:** - **Confusion Matrix:** Successfully identified true positive and true negative cases.
